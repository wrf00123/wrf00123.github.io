...
const websiteData = [{
    ...
    websites: [
        ...
        { name: "UKCA", url: "https://www.gov.uk/guidance/placing-ukca-or-ce-marked-products-on-the-market-in-great-britain",
            desc: "UKCA标志" },
        { name: "ITU", url: "https://www.itu.int/en/ITU-T/Pages/default.aspx", desc: "全球电信标准化" },
        { name: "IAF", url: "https://iaf.nu/en/home/", desc: "国际认证论坛" },
        { name: "ROHS2.0", url: "https://eur-lex.europa.eu/eli/dir/2011/65/oj/eng",
            desc: "电气电子设备有害物质限制指令2011/65/EU" },
        { name: "REACH清单", url: "https://echa.europa.eu/candidate-list-table", desc: "REACH查询" },
        { name: "REACH法规", url: "https://environment.ec.europa.eu/topics/chemicals/reach-regulation_en#law",
            desc: "REACH法规" },
        { name: "ZDHC", url: "https://www.roadmaptozero.com/mrsl?locale=zh_cn#CG",
            desc: "限用清单/程序/指南/实施方法" },
        ...
        { name: "GRS", url: "https://textileexchange.org/recycled-claim-global-recycled-standard/",
            desc: "全球回收标准" },
        { name: "UNECE", url: "https://unece.org/ghs-rev4-2011", desc: "GHS全球化学品统一分类和标签制度" },
        { name: "EN标准", url: "https://www.cencenelec.eu/", desc: "EN欧洲标准" },
        { name: "EASA", url: "https://www.easa.europa.eu/en/acceptable-means-compliance-and-guidance-material-group/part-21-airworthiness-and-environmental",
            desc: "欧洲航空安全局" },
        { name: "ASEAN DOCS", url: "https://docs.asean.org/SitePages/DocumentSearch.aspx", desc: "指南文件检索" },
        { name: "CE认证", url: "https://single-market-economy.ec.europa.eu/single-market/goods/ce-marking_en",
            desc: "产品认证" },
    ...
    icon: "fa-book",
    websites: [
        { name: "全国标准信息公共服务平台", url: "https://std.samr.gov.cn/",
            desc: "国家/行业/地方/团体/企业/国际/国外标准" },
        { name: "国家标准全文公开系统", url: "https://openstd.samr.gov.cn/bzgk/gb/index", desc: "GB/GBT/GBZ" },
        { name: "国际国家标准互查", url: "https://std.samr.gov.cn/gb/search/gbAdvancedSearch?type=std",
            desc: "ISO标准号查找国家标准号" },
    ...
    websites: [
        ...
        { name: "食品安全国家标准数据检索平台", url: "https://sppt.cfsa.net.cn:8086/db",
            desc: "GB/GBT/GBJ标准下载" },
        ...
        { name: "国家应急管理部", url: "https://www.mem.gov.cn/fw/flfgbz/bz/bzwb/",
            desc: "AQ/AQT/YGT/XFT/MT标准下载" },
        { name: "中华人民共和国商务部", url: "https://www.mem.gov.cn/fw/flfgbz/bz/bzwb/",
            desc: "SBT/WMT标准下载" },
        { name: "自然资源标准化信息服务平台", url: "http://www.nrsis.org.cn/portal/xxcx/std",
            desc: "TDT/TD/HYT/CHT/CH标准下载" },
        { name: "中国证券监督管理委员", url: "https://www.csrc.gov.cn/", desc: "标准" },
        { name: "国家文物局", url: "http://www.ncha.gov.cn/col/col2423/index.html", desc: "WWT标准下载" },
        { name: "矿山安全监察局", url: "https://www.chinamine-safety.gov.cn/zfxxgk/fdzdgknr/zcfg/hybz_01/mkanj/",
            desc: "MTT/MT标准下载" },
        { name: "铁路技术标准信息服务平台", url: "https://biaozhun.tdpress.com/", desc: "TB标准下载" },
        { name: "中国电力企业联合会", url: "https://dls.cec.org.cn/zhongdianlianbiaozhun/",
            desc: "TCEC标准下载" },
        { name: "交通运输部", url: "https://jtst.mot.gov.cn/arch/prof", desc: "JT标准下载" },
        { name: "中国气象局", url: "https://www.cma.gov.cn/", desc: "标准" },
        { name: "交通水利局", url: "https://wtis.mot.gov.cn/syportalapply/sysnoticezl/indexzl",
            desc: "JTS标准下载" },
        ...
        { name: "国家邮政局", url: "https://www.spb.gov.cn/gjyzj/c100009/c100012/common_list.shtml",
            desc: "YZ标准下载" },
        { name: "海关总署技贸措施网", url: "http://www.tbtsps.cn",
            desc: "GB/GBT/GBZ/GA/GAT/DB/LDT/WST/DAT/YYT/T../RBT/DL../HJ/JBT/QCT标准下载" },
        { name: "中国海关企业进出口信用信息",
            url: "http://credit.customs.gov.cn/ccppwebserver/pages/ccpp/html/ccppindex.html",
            desc: "中国海关企业进出口信用信息公示平台" },
        { name: "出口商品技术指南", url: "https://www.mofcom.gov.cn/cms_files/filemanager/ckzn/index.shtml",
            desc: "中华人民共和国商务部" },
        { name: "资本市场标准网", url: "http://www.csisc.cn/zbscbzw/c100208/yfb_gb_list.shtml#bzyfb",
            desc: "JR标准下载" },
        ...
        { name: "民用航空局", url: "https://www.caac.gov.cn/XXGK/XXGK/index_172.html?fl=15",
            desc: "CTSO/MHT/SC/JJF标准下载" },
        { name: "文化和旅游部", url: "https://zwgk.mct.gov.cn/zfxxgkml/447/471/index_3081.html",
            desc: "WHT/LBT标准下载" },
        { name: "国家气象局", url: "https://www.cma.gov.cn/zfxxgk/gknr/flfgbz/bz/index_4.html",
            desc: "QX/IDM标准下载" },
        { name: "国家粮食和物资储备局", url: "https://www.lswz.gov.cn/html/ywpd/bzzl/lybz.shtml",
            desc: "LST标准下载" },
        { name: "国家档案局", url: "https://www.saac.gov.cn/daj/hybz/dabz_list.shtml", desc: "DA标准下载" },
        { name: "水利部国际合作与科技司", url: "http://gjkj.mwr.gov.cn/jsjd1/bzh/bzhfbgg/index.htm",
            desc: "SL标准" },
        { name: "人力资源与社会保障部", url: "https://www.mohrss.gov.cn/SYrlzyhshbzb/zwgk/ghcw/bz/index.html",
            desc: "LDT标准下载" },
        ...
        { name: "住房和城乡建设部", url: "https://www.mohurd.gov.cn/gongkai/fdzdgknr/bzgg/index.html",
            desc: "CJ/JC/JG标准下载" },
    ...
    websites: [
        ...
        { name: "山西省市场监督管理局（知识产权局）",
            url: "https://scjgj.shanxi.gov.cn/gzzt/bzgl/dfbzcx/index.shtml", desc: "DB标准下载" },
        { name: "安徽省标准化信息服务", url: "https://bzxx.ahbz.org.cn/standInfo.html?tab=2", desc: "标准下载" },
        { name: "福建省标准信息服务平台", url: "http://pt.fjbz.org.cn:8060/StandardSearch/StdSearch.aspx",
            desc: "标准下载" },
        { name: "河南省地方标准公共服务平台", url: "http://www.hndb41.com/", desc: "标准下载" },
        { name: "成都市市场监督管理局（市知识产权局）",
            url: "https://scjg.chengdu.gov.cn/cdscjgj/c133654/nav_list.shtml", desc: "标准下载" },
        ...
        { name: "江西省质量和标准化研究院", url: "http://www.jxbz.org.cn/ZJHome/LocalStandard?TID=35",
            desc: "标准" },
    ...
    websites: [
        ...
        { name: "中关村材料试验技术联盟", url: "http://www.cstm.com.cn/channel/details/3-1-cstmbiaozhun?page=1",
            desc: "CSTM标准下载" },
        { name: "中国航空器拥有者及驾驶员协会", url: "https://www.aopa.org.cn/portal/modules/group/2",
            desc: "TAOPA标准下载" },
        { name: "中国教育装备行业协会", url: "https://www.ceeia.cn/news/55/", desc: "TJYBZ标准下载" },
        { name: "中国锻压协会", url: "http://www.china-metalforming-fabrication.com/bz/bz0",
            desc: "TCCMI标准下载" },
    ...
    websites: [
        ...
        { name: "OSHA的国家认可测试实验室 (NRTL) 计划",
            url: "https://www.osha.gov/nationally-recognized-testing-laboratory-program",
            desc: "美国劳工部" },
        { name: "ASQ", url: "https://asq.org/", desc: "美国质量协会" },
        { name: "ASTM标准", url: "https://store.astm.org/products-services/standards-and-publications/standards.html",
            desc: "美国材料实验协会" },
        { name: "CPSIA", url: "https://www.cpsc.gov/Regulations-Laws--Standards/Statutes/The-Consumer-Product-Safety-Improvement-Act",
            desc: "美国消费品安全委员会" },
        { name: "CTPAT", url: "https://www.cbp.gov/border-security/ports-entry/cargo-security/ctpat-customs-trade-partnership-against-terrorism/apply/security-criteria",
            desc: "美国海关-商贸反恐伙伴计划" },
        ...
        { name: "Blue Angel", url: "https://www.blauer-engel.de/en/certification/basic-award-criteria#UZ34-2017",
            desc: "德国蓝色天使生态认证标准" },
    ...
    websites: [
        ...
        { name: "特种设备安全检查局", url: "https://www.samr.gov.cn/tzsbj/zcfg/aqjsgf/index.html",
            desc: "安全技术规范" },
        { name: "国家统计局", url: "https://www.stats.gov.cn/", desc: "标准" },
        { name: "中国民用航空适航审定中心", url: "https://acc.caac.gov.cn/ZCFG/index.html", desc: "航空政策法规" },
        { name: "RBA", url: "https://www.responsiblebusiness.org/code-of-conduct/",
            desc: "责任商业联盟行为准则-标准" },
        { name: "EMAS", url: "https://green-forum.ec.europa.eu/green-business/emas_en",
            desc: "生态管理与审计计划" },
        { name: "GOTS标准", url: "https://global-standard.org/downloads", desc: "全球有机纺织标准" },
        { name: "BSCI标准", url: "https://www.amfori.org/document_solution/amfori-bsci/?section=members",
            desc: "amfori" },
        ...
        { name: "IFS HPC标准", url: "https://www.ifs-certification.com/en/ifs-portfolio/standards/hpc-standard",
            desc: "标准" },
        { name: "FSC认证", url: "https://connect.fsc.org/document-centre", desc: "森林认证标准" },
        { name: "ESCP", url: "https://www.ethicalsupplychain.org/zh/resource/factory/audit-checklist",
            desc: "供应链责任规范标准" },
        { name: "EPEAT 2.0标准", url: "https://www.epeat.net/about/epeat-criteria",
            desc: "电子产品环境影响评估" },
        { name: "ICS", url: "https://ics-asso.org/resources/#1617967310959-18ea5aee-152a",
            desc: "合规与可持续发展倡议" },
        ...
        { name: "TAPA", url: "https://tapa.memberclicks.net/freight-broker-security-requirements-fbsr-",
            desc: "运输资产保护协会" },
        ...
        { name: "OEKO-TEX Standard 100", url: "https://www.oeko-tex.com/zh/%E4%B8%8B%E8%BD%BD/",
            desc: "纺织品有害物质检测" },
        { name: "ASC", url: "https://programme-centre.asc-aqua.org/resource-hub/?rname&type%5B0%5D=Standard",
            desc: "水产养殖管理委员会" },
        { name: "WMO", url: "https://wmo.int/zh-hans", desc: "世界气象组织" },
        { name: "MSC", url: "https://www.msc.org/standards-and-certification/fisheries-standard",
            desc: "渔业标准|海洋管理委员会" },
        { name: "Energy Star", url: "https://www.energystar.gov/", desc: "能源之星" },
        { name: "Nordic Swan", url: "https://www.nordic-swan-ecolabel.org/criteria/",
            desc: "北欧白天鹅生态标志" },
        { name: "Fairtrade", url: "https://www.fairtrade.net/en/why-fairtrade/how-we-do-it/standards/who-we-have-standards-for.html",
            desc: "公平贸易认证标准" },
        { name: "BCI", url: "https://bettercotton.org/what-we-do/defining-better-our-standard/",
            desc: "良好棉花倡议" },
        { name: "WRAP", url: "https://wrapcompliance.org/en/certification/",
            desc: "全球责任服装生产认证标准" },
        { name: "ISCC", url: "https://iscc-system.org/certification/iscc-documents/",
            desc: "国际可持续性和碳认证标准" },
        { name: "Common Criteria", url: "https://www.commoncriteriaportal.org/cc/index.cfm",
            desc: "信息技术安全评估标准" },
        { name: "TISAX认证", url: "https://www.commoncriteriaportal.org/cc/index.cfm",
            desc: "ENX可信信息安全评估交换" },
        { name: "SLCP", url: "https://slcp.zendesk.com/hc/en-us/articles/6894013905692-Download-Verifier-Guidance-how-do-I-verify-a-facility-s-answer-to-a-Tool-question",
            desc: "社会劳工整合标准" },
        { name: "UNGC", url: "https://cn.unglobalcompact.org/index.html", desc: "联合国全球契约组织" },
        { name: "ILO", url: "https://normlex.ilo.org/dyn/nrmlx_en/f?p=NORMLEXPUB:12000:0::NO:::",
            desc: "国际劳工组织-劳工标准" },
        { name: "ILO公约全文", url: "https://cn.fsc.org/cn-zh/ilohexinlaogongyaoqiuxiangguanfalufagui/ilogongyuequanwen",
            desc: "ILO公约全文" },
        ...
        { name: "IFRS S2气候相关披露",
            url: "https://www.ifrs.org/issued-standards/ifrs-sustainability-standards-navigator/ifrs-s2-climate-related-disclosures/#about",
            desc: "IFRS S2气候相关披露-ESG相关标准" },
        { name: "IFRS S1可持续发展相关财务信息披露的一般要求",
            url: "https://www.ifrs.org/issued-standards/ifrs-sustainability-standards-navigator/ifrs-s1-general-requirements/",
            desc: "IFRS S1可持续发展相关财务信息披露的一般要求-ESG相关标准" },
        { name: "OECD", url: "https://www.oecd.org/zh/publications/12182cb3-zh.html",
            desc: "经合组织跨国企业负责任商业行为准则-ESG相关标准" },
        { name: "ISO26000", url: "https://www.iso.org/iso-26000-social-responsibility.html",
            desc: "社会责任指南-ESG相关标准" },
        { name: "IIRC", url: "https://integratedreporting.org", desc: "国际综合报告框架-ESG相关标准" },
        { name: "IETP", url: "https://www.ethicalsupplychain.org/resource/factory/audit-checklist",
            desc: "IETP社会责任合规标准-ICTI审厂-ESG评级相关" },
        { name: "WRAP认证", url: "https://wrapcompliance.org/zh/certification/certification-explained/",
            desc: "WRAP认证实施手册-ESG评级相关" },
        { name: "SA8000", url: "https://sa-intl.org/resources/sa8000-standard/", desc: "社会责任-ESG评级相关" },
        { name: "SLCP 审计", url: "https://slcp.zendesk.com/hc/en-us/articles/6808698730780-Download-Data-Collection-Tool-which-questions-are-included-in-the-Tool",
            desc: "SLCP审计清单工具-ESG评级相关" },
        ...
        { name: "TfS 审计", url: "https://www.tfs-initiative.com/how-we-do-it/audit#documents",
            desc: "TfS 审计清单-ESG评级相关" },
        ...
        { name: "中关村材料试验技术联盟",
            url: "https://www.ccs.org.cn/ccswz/special?columnid=201900002000000016&id=0", desc: "标准" },
        ...
        { name: "中国就业培训技术指导中心", url: "https://chinajob.mohrss.gov.cn/ywpd/pxjd/rmzt/zyjnbz/zcwj/",
            desc: "标准下载" },
        { name: "小绿典", url: "https://dljs123.com/#/search/criteria", desc: "标准下载" },
        { name: "标准网",
            url: "https://bbs.biaozhuns.com//home.php?mod=space&uid=2047951&do=profile&mycenter=1&mobile=2",
            desc: "标准下载（论坛）每72h限1次" },
    ...
    websites: [
        ...
        { name: "MDSAP（日本、巴西、澳大利亚）",
            url: "https://www.fda.gov/medical-devices/medical-device-single-audit-program-mdsap/mdsap-international-regulations-english-australia-brazil-canada-japan-and-usa",
            desc: "MDSAP五国的QMS相关法规" },
        ...
        { name: "国家药品监督管理局3", url: "http://app.nifdc.org.cn/jianybz/jybzTwoGj.do?formAction=listQxtjbz",
            desc: "GBT标准下载" },
        { name: "国家药品监督管理局4", url: "http://app.nifdc.org.cn/jianybz/jybzTwoGj.do?formAction=listYlqx",
            desc: "GB标准下载" },
        { name: "国家药品监督管理局医疗器械技术",
            url: "https://www.cmde.org.cn/flfg/zdyz/flmlbzh/flmlylqx/index.html", desc: "YYT标准下载" },
        ...
        { name: "欧盟器械最新资讯", url: "https://ec.europa.eu/health/medical-devices-sector/latest-updates_en",
            desc: "资讯" },
        { name: "欧盟通用规范", url: "https://ec.europa.eu/info/law/better-regulation/have-your-say/initiatives_en",
            desc: "通用规范/指南" },
        { name: "欧盟医疗器械协调小组", url: "https://ec.europa.eu/health/md_sector/new_regulations/guidance_en",
            desc: "MDCG模块医疗器械的相关指南" },
        { name: "EUDAMED", url: "https://health.ec.europa.eu/medical-devices-eudamed/overview_en",
            desc: "欧盟医疗器械数据库系统" },
        ...
        { name: "MEDDEV指南", url: "https://ec.europa.eu/health/md_sector/current_directives_en",
            desc: "MEDDEV更新的医疗器械指南文件" },
        { name: "FDA（注册）", url: "https://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfRL/rl.cfm/",
            desc: "美国医疗器械注册查询" },
        { name: "最新的医疗器械指南文件",
        ...
        { name: "510(k) Premarket Notification",
            url: "https://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfPMN/pmn.cfm", desc: "美国FDA" },
        { name: "产品分类数据库", url: "https://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfpcd/classification.cfm",
            desc: "美国FDA" },
        { name: "CDRH学习", url: "https://www.fda.gov/training-and-continuing-education/cdrh-learn美国FDA",
            desc: "美国FDA" },
        { name: "FDA认可标准数据库",
            url: "https://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfStandards/search.cfm", desc: "美国FDA" },
        { name: "QMSR", url: "https://www.fda.gov/medical-devices/postmarket-requirements-devices/quality-management-system-regulation-qmsr",
            desc: "美国FDA|质量管理体系法规" },
        { name: "自由信息法案", url: "https://www.fda.gov/regulatory-information/freedom-information",
            desc: "美国FDA" },
        { name: "UDI", url: "https://www.fda.gov/medical-devices/device-advice-comprehensive-regulatory-assistance/unique-device-identification-system-udi-system#ruleguidance",
            desc: "美国FDA" },
        { name: "FDA账号注册与登录", url: "https://www.access.fda.gov/oaa/logonFlow.htm?execution=e1s1",
            desc: "美国FDA" },
        { name: "FDA法规简介", url: "https://www.fda.gov/medical-devices/device-advice-comprehensive-regulatory-assistance",
            desc: "美国FDA" },
        { name: "MDR信息上报", url: "https://www.fda.gov/medical-devices/medical-device-safety/reporting-allegations-regulatory-misconduct",
            desc: "美国FDA" },
        { name: "召回数据库", url: "https://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfRES/res.cfm",
            desc: "美国FDA" },
        ...
        { name: "加拿大卫生局（注册）", url: "https://health-products.canada.ca/mdall-limh/prepareSearch?type=active",
            desc: "加拿大医疗器械注册查询" },
        { name: "加拿大法规SOR/98-282", url: "https://lois-laws.justice.gc.ca/eng/regulations/SOR-98-282/index.html",
            desc: "SOR/98-282法规下载" },
        { name: "加拿大MDR", url: "https://laws-lois.justice.gc.ca/eng/regulations/",
            desc: "关注加拿大MDR医疗器械法规的变化" },
        { name: "加拿大医疗器械最新消息",
            url: "https://www.canada.ca/en/health-canada/services/drugs-health-products/medical-devices/what-new.html",
            desc: "关注加拿大医疗器械相关的最新动态" },
        { name: "日本PMDA（注册）",
            url: "https://www.pmda.go.jp/review-services/drug-reviews/foreign-mfr/0003.html",
            desc: "医疗器械注册查询" },
        { name: "日本法规翻译", url: "https://www.japaneselawtranslation.go.jp/en/laws",
            desc: "关注日本医疗器械法规的变化" },
        ...
        { name: "ANVISA",
            url: "https://anvisalegis.datalegis.net/action/ActionDatalegis.php?acao=abrirLegislacao&cod_modulo=134&cod_menu=1696",
            desc: "国家卫生监测局-巴西" },
        { name: "第三方咨询机构Emergo",
            url: "https://www.emergobyul.com/resources/regulations-brazil",
            desc: "巴西Resolution-RDC-16-2013（BGMP）GMP要求" },
        ...
        { name: "德国Bfarm", url: "https://www.bfarm.de/EN/News/News-from-the-divisions/Medical-devices-news/_node.html",
            desc: "德国主管当局信息更新" },
        { name: "MDA", url: "https://www.mda.gov.my/", desc: "马来西亚医疗器械法规及指南文件" },
        { name: "食品和药品安全部官网", url: "https://www.mfds.go.kr/eng/index.do", desc: "韩国食品和药品" },
        { name: "瑞士卫生部", url: "https://www.swissmedic.ch/swissmedic/en/home/news.html",
            desc: "关注瑞士医疗器械法规变化" },
        { name: "菲律宾FDA官网", url: "https://www.fda.gov.ph/", desc: "关注菲律宾医疗器械法规的变化" },
        { name: "GMP1001", url: "https://www.gmp1001.com/h-col-109.html",
            desc: "药品/医疗器械/化妆品GMP标准" },
    ...
    websites: [
        ...
        { name: "UNECE",
            url: "https://unece.org/?__cf_chl_f_tk=ZNIknW1wf8MEfcsYmDxckNkNiO2dkvyDhwhqUIje1HY-1782955368-1.0.1.1-uEuVRlu9Jyr.5211TrFEtlEKmRmhpOetPRIYOGR9ivg",
            desc: "汽车法规体系" },
    ...
    icon: "fa-id-card",
    websites: [
        { name: "全国认证认可信息公共服务平台", url: "http://cx.cnca.cn/CertECloud/index/index/page",
            desc: "认证资质查询" },
        { name: "CNAS", url: "https://www.cnas.org.cn/rkgf/rzjgrk/index.html", desc: "中国合格评定国家认可委员会-认证规则" },
        { name: "GLOBAC", url: "https://globalaccreditationcooperationincorporated.org/",
            desc: "全球认可合作组织" },
        { name: "APAC", url: "https://www.apac-accreditation.org/", desc: "亚太认可合作组织" },
        { name: "全国排污许可证管理信息平台",
            url: "https://permit.mee.gov.cn/permitExt/outside/PageQueryServlet?pageno=1&type=Law",
            desc: "排污许可证" },
        { name: "高新技术企业认定工作网", url: "http://www.innocom.gov.cn/?ref=https://szsyw.cn", desc: "资质查询" },
        { name: "深i企", url: "https://www.szsiq.com/#/specialized?temp=1770014537978",
            desc: "专精特新中小企业查询（仅限深圳企业）" },
        { name: "优质中小企业梯度培育平台", url: "https://zjtx.miit.gov.cn/zxqySy/main",
            desc: "科技型/创新型/专精特新/专精特新“小巨人”中小企业" },
        { name: "建筑工程施工许可证电子证照查询",
            url: "https://jzsc.mohurd.gov.cn/data/elePermit?ref=https%3A%2F%2Fszsyw.cn", desc: "资质查询" },
        ...
        { name: "食品经营许可管理系统", url: "https://spjyxk.gsxt.gov.cn/cfdaPub/index/page/",
            desc: "食品经营许可管理系统" },
        { name: "法人库特殊食品监管子库信息查询系统",
            url: "https://tszkcx.gsxt.gov.cn/corplib_public/ent_search?ref=https://szsyw.cn", desc: "资质查询" },
        { name: "特殊食品信息查询平台", url: "http://ypzsx.gsxt.gov.cn/specialfood/?ref=https://szsyw.cn#/food",
            desc: "资质查询" },
        { name: "全国快递业务许可", url: "https://zwfw.spb.gov.cn/xkqy?ref=https://szsyw.cn", desc: "资质查询" },
        { name: "商业特许经营信息管理", url: "http://txjy.syggs.mofcom.gov.cn/?ref=https://szsyw.cn",
            desc: "资质查询" },
        { name: "质量证书查询", url: "https://www.cqc.com.cn/www/chinese/zscx/?ref=https://szsyw.cn",
            desc: "资质查询" },
        ...
        { name: "安标国家矿用产品安全标志中心", url: "https://www.aqbz.org/?ref=https://szsyw.cn#/home",
            desc: "资质查询" },
        { name: "电信业务市场综合管理信息系统", url: "https://tsm.miit.gov.cn/dxxzsp/?ref=https://szsyw.cn",
            desc: "资质查询" },
        { name: "新闻总署从业机构和产品查询", url: "https://www.nppa.gov.cn/bsfw/cyjghcpcx/?ref=https://szsyw.cn",
            desc: "资质查询" },
        { name: "演出行业协会", url: "https://capa.com.cn/?ref=https://szsyw.cn#/index/HomePage",
            desc: "资质查询" },
        { name: "新闻记者证查询", url: "https://press.nppa.gov.cn/?ref=https://szsyw.cn", desc: "资质查询" },
        { name: "全国矿业权人勘查开采信息管理系统",
            url: "https://kyqgs.mnr.gov.cn/index.jhtml?ref=https://szsyw.cn", desc: "资质查询" },
    ...
    websites: [
        ...
        { name: "最高人民法院公报", url: "http://gongbao.court.gov.cn/?ref=https://szsyw.cn",
            desc: "最高人民法院公报" },
        { name: "国家法律法规数据库", url: "https://flk.npc.gov.cn/index", desc: "国家法律法规数据库" },
        { name: "国家规章库", url: "https://www.gov.cn/zhengce/xxgk/gjgzk/index.htm?searchWord=",
            desc: "国家规章库" },
        ...
        { name: "国家企业信用信息公示系统", url: "http://www.gsxt.gov.cn/",
            desc: "企业工商/行政处罚/经营异常/违法查询" },
        { name: "中国裁判文书网", url: "https://wenshu.court.gov.cn/", desc: "企业涉诉信息查询" },
        { name: "中国执行信息公开网", url: "https://zxgk.court.gov.cn/",
            desc: "企业执行案件/失信被执行人/限制消费人员" },
        { name: "职业卫生技术服务机构信息系统", url: "https://jsfw.zyjkfw.cn/",
            desc: "全国职业卫生放射卫生技术服务机构管理信息系统" },
        { name: "中国电子质量监督(e-CQS)公共服务门户", url: "https://psp.e-cqs.cn/egov/iwantMore.jsp?type=1",
            desc: "中国电子质量监督(e-CQS)公共服务门户" },
        { name: "证券期货法规数据库系统", url: "https://neris.csrc.gov.cn/falvfagui/?ref=https://szsyw.cn",
            desc: "证券期货法规数据库系统" },
    ...
    websites: [
        ...
        { name: "广西合同格式", url: "http://221.7.197.159:8088/www/template_list.aspx?ref=https://szsyw.cn",
            desc: "合同范本" },
        { name: "武汉合同格式", url: "https://scjgj.wuhan.gov.cn/bsfw/htgl_65/htfb/?ref=https://szsyw.cn",
            desc: "合同范本" },
        { name: "河南合同格式", url: "https://scjg.henan.gov.cn/ztzl/htsfwb/", desc: "合同范本" },
        { name: "杭州市合同格式", url: "https://scjg.hangzhou.gov.cn/col/col1694849/index.html?ref=https://szsyw.cn",
            desc: "合同范本" },
        { name: "广州市合同格式", url: "https://scjgj.gz.gov.cn/zwfw/fwxz/htsfwb/?ref=https://szsyw.cn",
            desc: "合同范本" },
        { name: "上海市合同格式", url: "https://scjgj.sh.gov.cn/057/?ref=https://szsyw.cn", desc: "合同范本" },
        { name: "黑龙江合同格式", url: "http://amr.hlj.gov.cn/", desc: "合同范本" },
        { name: "新疆维吾尔自治区合同格式",
            url: "https://scjgj.xinjiang.gov.cn/xjaic/htsfwb/202001/be58291df7344eb8be772d64d8ad71ea.shtml?ref=https://szsyw.cn",
            desc: "合同范本" },
        { name: "深圳市合同格式", url: "https://amr.sz.gov.cn/zxbs/zhxx/htsf/index.html", desc: "合同范本" },
        { name: "华律合同范本库", url: "https://www.66law.cn/contractmodel/?ref=https://szsyw.cn",
            desc: "合同范本" },
    ...
    websites: [
        ...
        { name: "Temu",
            url: "https://www.temu.com/us-zh-Hans?_x_sessn_id=p8v8dwhd6w&refer_page_name=home&refer_page_id=10005_1768986853524_0fn92s00k7&refer_page_sn=10005",
            desc: "采购平台" },
    ...
    websites: [
        ...
        { name: "图片添加水印", url: "https://wrf00123.github.io/tool24.html", desc: "文字和图片水印" },
    ...
    websites: [
        ...
        { name: "markdowntoword", url: "https://markdowntoword.io/zh/tools/markdown-to-pdf",
            desc: "Markdown转pdf" },
    ...
    websites: [
        ...
        { name: "篡改猴脚本", url: "https://greasyfork.qytechs.cn/zh-CN/scripts/by-site/bilibili.com",
            desc: "文件转二维码" },
        { name: "Clarity",
            url: "https://clarity.microsoft.com/demo/projects/view/3t0wlogvdz/dashboard?date=Last%203%20days",
            desc: "网站使用统计工具" },
        { name: "Tiny Wow", url: "https://tinywow.com/", desc: "工具汇集" },
        { name: "SVG Repo", url: "https://www.svgrepo.com/", desc: "图标工具" },
        { name: "filecompress", url: "https://filecompress.org/zh-cn/documents-tools/compress-xlsx",
            desc: "excel文件体积压缩" },
        ...
        { name: "LOL Colors", url: "https://www.webdesignrankings.com/resources/lolcolors/?ref=https://szsyw.cn",
            desc: "色系查询" },
    ...
    websites: [
        ...
        { name: "ev录屏",
            url: "https://www.sootool.net/nexus/bi1/evluping.shtml?msclkid=1ea8e3bd237c12b4823d8b092c630dd1",
            desc: "录屏" },
        { name: "Everything", url: "https://www.voidtools.com/zh-cn/downloads/", desc: "文件检索" },
        { name: "Umi-OCR",
            url: "https://gitee.com/mirrors/Umi-OCR#https://gitee.com/link?target=https%3A%2F%2Fhiroi-sora.lanzoul.com%2Fs%2Fumi-ocr",
            desc: "OCR" },
        ...
        { name: "Minitab操作步骤概述", url: "https://support.minitab.com/zh-cn/minitab/help-and-how-to/",
            desc: "操作步骤概述" },
    ...
    websites: [
        ...
        { name: "文档解析助手", url: "http://125.208.22.28:8080/zhushou/?code=3pK8duHBI1LFszVyj",
            desc: "文档解析助手" },
    ...
    websites: [
        ...
        { name: "TRAE WORK",
            url: "https://work.trae.cn/?utm_source=content&utm_medium=doc_solo&utm_campaign=quickstart&mode=mtc",
            desc: "在线AI" },
        { name: "腾讯元宝", url: "https://yuanbao.tencent.com/chat/naQivTmsDa", desc: "在线AI" },
        { name: "WorkBuddy",
            url: "https://www.codebuddy.cn/work/?fromSource=gwzcw.12117220.12117220.12117220&utm_medium=cpc&utm_id=gwzcw.12117220.12117220.12117220&msclkid=c334d204d0941fbf4f34b8417e9f9a37",
            desc: "自动化AI-软件" },
        ...
        { name: "即梦AI",
            url: "https://jimeng.jianying.com/ai-tool/home/?utm_medium=bingpc&utm_source=pinzhuan&utm_campaign=button",
            desc: "视频生成" },
        { name: "可灵AI", url: "https://app.klingai.com/cn/image-to-video/frame-mode/new?ra=4", desc: "视频生成" },
        { name: "腾讯混元AI视频", url: "https://video.hunyuan.tencent.com/login?redirect=/?utm_source=maomu.com",
            desc: "视频生成" },
        { name: "呜哩AI", url: "https://wuli.art/generate", desc: "视频生成" },
        { name: "百度AI",
            url: "https://chat.baidu.com/search?isShowHello=1&extParams=%7B%22out_enter_type%22%3A%22sidebar_dialog%22%2C%22enter_type%22%3A%22sidebar_dialog%22%2C%22forceRefresh%22%3Atrue%7D",
            desc: "在线AI" },
        ...
        { name: "扣子空间",
            url: "https://space.coze.cn/?from=landingpage&keywordid=%E6%89%A3%E5%AD%90%E7%A9%BA%E9%97%B4-&msclkid=beda8a449f5a1495141ee2f6e949910b&utm_campaign=486599295&utm_content=home&utm_id=0&utm_medium=sem&utm_source=bing&utm_source_platform=pc&utm_term=coze_bing_sem_dm_cpc_pc_czkj_pp_guanw_1&category=7524912604796452873",
            desc: "在线AI" },
        { name: "TRAE",
            url: "https://www.trae.cn/sem?utm_source=bing&utm_medium=bing_sem&utm_campaign=486432838&utm_term=trae_bing_sem_dm_pc_cpc_tongy_aibczs_dmsc_1&msclkid=631e30d0a1751fa2ce4e582fd990f7a3",
            desc: "代码生成软件" },
    ...
    websites: [
        ...
        { name: "问卷星",
            url: "https://www.wjx.cn/newwjx/manage/myquestionnaires.aspx?randomt=1744110951",
            desc: "问卷调查" },
    ...
    websites: [
        ...
        { name: "方方格子不显示", url: "http://ffcell.com/WenKu/Data/2016051616004881.html",
            desc: "方方格子不显示教程" },
    ]
}, {
    id: 25,
    ...
    websites: [
        ...
        { name: "中国历史朝代顺序表", url: "https://www.lishimingren.com/chaodai/?src=www.jspoo.com",
            desc: "中国历史朝代顺序表" },
        { name: "中国历史地名", url: "https://newarchive.ihp.sinica.edu.tw/hplname/placename/basic/",
            desc: "中国历史地名" },
    ...
    websites: [
        ...
        { name: "狗屁不通文章生成器", url: "https://suulnnka.github.io/BullshitGenerator/index.html",
            desc: "文章" },
    ...
    websites: [
        ...
        { name: "outlook",
            url: "https://www.microsoft.com/zh-cn/microsoft-365/outlook/email-and-calendar-software-microsoft-outlook?deeplink=%2fmail%2f0%2f%3fnlp%3d0&sdf=0",
            desc: "邮箱" },
